...
import br.com.fiap.com.excecao.Excecao;
...
public class EventoServlet extends HttpServlet {
	...
	private void listarEvento(HttpServletRequest request, HttpServletResponse response) 
			...
			List<Evento> listaEventos = EventoBO.consultaPorUsuario(2); //ALTERAR
		
			request.setAttribute("LISTA_EVENTO", listaEventos);
					
			RequestDispatcher dispatcher = request.getRequestDispatcher("/listaEvento.jsp");
	...
	private void carregarEvento(HttpServletRequest request, HttpServletResponse response) 
			...
			Evento evento = EventoBO.consultaEvento(codEvento);
			
			request.setAttribute("EVENTO", evento);
			
			RequestDispatcher dispatcher = 
					request.getRequestDispatcher("/edicaoEvento.jsp");
			dispatcher.forward(request, response);		
		}
